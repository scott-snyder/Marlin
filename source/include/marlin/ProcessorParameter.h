...
namespace marlin{
  ...
  public:
    ...
    ProcessorParameter() :
      _description(""), _name(""),
      _setSize(0), _optional(false), _valueSet(false) {}
...
//   }
  ...
  public:
    ...
    virtual const std::string  type() {  
      ...
      if     ( typeid( _parameter ) == typeid( lcio::IntVec    )) return "IntVec" ;
      else if( typeid( _parameter ) == typeid( lcio::FloatVec  )) return "FloatVec" ;
      else if( typeid( _parameter ) == typeid( lcio::StringVec )) return "StringVec" ;
