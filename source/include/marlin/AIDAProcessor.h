 ...
 *  No input needed for this processor. Make sure it is included in the list of
 * active processors before any processor that books/fills histograms.
 *
 *  <h4>Output</h4>
 *  none
 *
 ...
 * @param FileType  type of output file xml (default) or root ( only
 * OpenScientist)
 *
 *  @author F. Gaede, DESY
