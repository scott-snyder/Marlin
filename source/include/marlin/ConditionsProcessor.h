...
//    */
 ...
 protected:
  ...
  lcio::StringVec _simpleHandlerInit{};

  /** initialization of DBCondHandlers */
  lcio::StringVec _dbcondHandlerInit{};

  /** initialization of DBFileHandlers */
  lcio::StringVec _dbfileHandlerInit{};

  /** initialization of DataFileHandlers */
  lcio::StringVec _datafileHandlerInit{};

  /** the names of all handlers */
  lcio::StringVec _condHandlerNames{};
