 ...
 */
  ...
  private:
    ...
    const lcio::StringVec _error_desc{ "Processor has no Parameters", "Processor not available!", "Some Collections have Errors"}; // error descriptions for all processors
    lcio::StringVec _errors{};	    // list of errors found in a processor
